...
3) Environment variables
  ...
  - In Vercel, add the same variables in Project Settings → Environment Variables. Mark `SUPABASE_SERVICE_ROLE` or `SUPABASE_SERVICE_ROLE_KEY` as "Secret" and do NOT expose them to the client.
